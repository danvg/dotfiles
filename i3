...
bindsym $mod+Ctrl+m exec $default_terminal -e 'alsamixer'
bindsym $mod+h split h;exec notify-send 'tile horizontally'
bindsym $mod+v split v;exec notify-send 'tile vertically'

## IMPORTANT sink volume can be queried with pactl list sinks
...
# bindsym Shift+XF86AudioNext exec "mpc seek +0:0:15"
# bindsym Shift+XF86AudioPrev exec "mpc seek -0:0:15"
